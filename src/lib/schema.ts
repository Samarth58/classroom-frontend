...
export const classSchema = z.object({
    ...
    // These are required in the backend, but your current create form does not
    // yet provide banner upload fields. Make optional until the upload widget
    // is wired to the form.
    bannerUrl: z
